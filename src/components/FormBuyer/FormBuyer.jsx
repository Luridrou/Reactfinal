...
const FormBuyer = () => {
    ...
    return (
        <> 
            ...
            ?
                <>      
                    <h4 className="mt-5 text-center">Cargando su orden, espere un momento...</h4>
                    <LoaderSecondary />
                </>
            :
            orderId
            ? 
                <div className="container">
                    <div className="py-5 text-center mt-5">
                        ...
                        <strong>Su ID de compra es {orderId}</strong><br />
                            ...
                            <div className="col-12">
                                ...
                                >
                                    <div className="mb-3 d-flex flex-column align-items-center">
                                        ...
                                        <input type="name" className="form-control form-control--color" name="name" placeholder="Cosme Fulanito" defaultValue={formData.name} required />
                                    </div>
                                    <div className="mb-3 d-flex flex-column align-items-center">
                                        <label className="form-label">Teléfono</label>
                                        <input type="number" className="form-control form-control--color" name="phone" placeholder="11xxxxxxxxx" defaultValue={formData.phone} required />
                                    </div>
                                    <div className="mb-3 d-flex flex-column align-items-center">
                                        <label className="form-label">Email</label>
                                        <input type="email" className="form-control form-control--color" name="email" placeholder="ejemplo@ejemplo.com" defaultValue={formData.email} required />
                                    </div>
                                    <div className="mb-3 d-flex flex-column align-items-center">
                                        <label className="form-label">Confirmar Email</label>
                                        <input type="email" className="form-control form-control--color" name="emailConfirm" placeholder="ejemplo@ejemplo.com" defaultValue={formData.emailConfirm} required />
                                    </div>
